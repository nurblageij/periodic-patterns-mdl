                ...
                for line in fp:
                    ...
                    if ttmp is not None:
                        if len(collected_results[series]["cls"]) == 0:
                            collected_results[series]["cls"] = list(map(float, [ttmp.group("cl_res"), ttmp.group("cl"), ttmp.group("prc_cl")]))
                            which = "H"
                        else:
                            collected_results[series]["cls"].extend(list(map(float, [ttmp.group("cl"), ttmp.group("prc_cl")])))
                            which = "F"
                    else:
